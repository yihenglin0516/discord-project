...
class Data (): #裡面放不同的hash
    ...
    def save(self,ctx): #ctx為context物件
        ...
        response=requests.get("https://api.jsonstorage.net/v1/json/f8301287-69bc-4166-90e7-7e51f02dd224")   
        raw=response.json()
        #寫入
        ...
        print(raw)
        update=requests.put("https://api.jsonstorage.net/v1/json/f8301287-69bc-4166-90e7-7e51f02dd224" 
        ,json=raw
        )
        print(update)
